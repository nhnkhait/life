			...
			<div class="col-md-12">
				<div class="hero-ct">
					...
					<ul class="breadcumb">
						...
						<li> <span class="ion-ios-arrow-right"></span>Phim Bộ</li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="col-md-8 col-sm-12 col-xs-12">
				...
				<div class="flex-wrap-movielist">
						<div class="movie-item-style-2 movie-item-style-1">
							<img src="images/uploads/series-img.jpg" alt="" style="width:170px; height:261px">
							<div class="hvr-inner">
	            				<a  href="series-single.php"> Xem Thêm <i class="ion-android-arrow-dropright"></i> </a>
	            			</div>
							<div class="mv-item-infor">
								<h6><a href="#">Vụ Nổ Lớn</a></h6>
